...
class D2STGNN(nn.Module):
    ...
    def __init__(self, **model_args):
        ...
        self.fc_his_t = nn.Sequential(nn.Linear(96, 512), nn.ReLU(), nn.Linear(512, self._forecast_dim), nn.ReLU())
        self.fc_his_s = nn.Sequential(nn.Linear(96, 512), nn.ReLU(), nn.Linear(512, self._forecast_dim), nn.ReLU())
